...
router.get('/profile', checkAuth_middleware_1.default, authController.profilePage);
router.patch('/profile', checkAuth_middleware_1.default, upload.single("avatar"), uploadCloud.uploadSingle, authController.profileUpdate);
