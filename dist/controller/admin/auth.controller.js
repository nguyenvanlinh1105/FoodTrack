...
exports.profileUpdate = exports.profilePage = exports.passwordReset = exports.passwordResetPage = exports.otp = exports.passwordOTPPage = exports.passwordForgot = exports.passwordForgotPage = exports.logout = exports.login = exports.loginPage = void 0;
...
const getMapEmbedUrl_helper_1 = __importDefault(require("../../helper/getMapEmbedUrl.helper"));
...
const profileUpdate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _a = req.body, { password, 'password-confirm': passwordConfirm, diaChi } = _a, otherData = __rest(_a, ["password", 'password-confirm', "diaChi"]);
    ...
    if (diaChi) {
        const mapEmbedUrl = yield (0, getMapEmbedUrl_helper_1.default)(diaChi);
        if (mapEmbedUrl) {
