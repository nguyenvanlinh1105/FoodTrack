...
const checkMessagesUnread = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const listUnreadMessages = yield allModel.TinNhan.findAll({
        where: {
            tinhTrang: 0
        },
        raw: true
    ...
    for (const chat of listUnreadMessages) {
        const user = yield allModel.ChiTietPhongChat.findOne({
            where: {
...
exports.default = checkMessagesUnread;
