...
public class myorders_donHuy_list_adapter extends ArrayAdapter<DonHangModel> {

    public myorders_donHuy_list_adapter(Context context, ArrayList<DonHangModel> arrayListDonHang) {
    ...
    public View getView(int position, @Nullable View view, @NonNull ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_myorders_donhuy_list, parent, false);
        }
...
//        TextView name = view.findViewById(R.id.name_item_myOrders);
        ...
        TextView txt_thoiGianHuy = view.findViewById(R.id.txt_thoiGianHuy);
